...
import { ReminderJob, ReminderType, ReminderStatus, ReminderPriority } from '../entities/ReminderJob';
...
export class ReminderJobRepository extends BaseRepository<ReminderJob> {
  ...
  constructor() {
    super(ReminderJob, 'ReminderJob');
  }

  /**
   * Create a new reminder job
   */
  async createReminderJob(tenantContext: TenantContext, data: CreateReminderJobData): Promise<ReminderJob> {
