...
export class OrganizationRepository extends BaseRepository<Organization> {
  ...
  async updateNameAndSlug(
    ...
    try {
      ...
      const updatedOrganization = await this.findById(organizationId);
  ...
  async getOrCreateDefaultOrganization(): Promise<Organization> {
    ...
    try {
      ...
      let defaultOrg = await this.findById(defaultOrgId);
      ...
      if (!defaultOrg) {
        ...
        defaultOrg = await this.findById(defaultOrgId);
      }
