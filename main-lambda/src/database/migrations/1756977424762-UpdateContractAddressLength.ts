...
export class UpdateContractAddressLength1756977424762 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_314f713cd1291f26c58a1a025a"`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_314f713cd1291f26c58a1a025a" ON "tokens" ("contract_address", "chain_id") `);
    }
