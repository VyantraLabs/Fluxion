...
export interface User {
  ...
  email?: string;
  display_name?: string;
  role?: string; // Single role: super_admin > system_admin > owner > admin > member > viewer
  ...
  created_at: string;
  updated_at: string;
  // SECURITY: Admin flags are NOT included in API responses - they're in JWT tokens only
}
